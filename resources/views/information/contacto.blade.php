...
{{--                <br>--}}
{{--                <h2>Contactar al laboratorio: minervarvlab.fmo@ues.edu.sv</h2>--}}
...
@section('content')
    ...
    <div class="container-sm mt-5 mb-5 " style="max-width: 650px; height: auto;">
        <div class="row">
            <div class="col-12 bg-white p-5 text-center border border-dark" style="border-radius: 3px;">
                <br>
                <h2>Contáctanos a través de: minervarvlab.fmo@ues.edu.sv</h2>
                <p>Estamos abiertos a cualquier sugerencia o consulta que desees compartir con nosotros.</p>
